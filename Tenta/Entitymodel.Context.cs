...
namespace Tenta
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual int InsertCustomer(string customerID, string companyName, string contactName, string contactTitle, string address, string city, string region, string postalCode, string country, string phone, string fax)
        {
            var customerIDParameter = customerID != null ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertCustomer", customerIDParameter, companyNameParameter, contactNameParameter, contactTitleParameter, addressParameter, cityParameter, regionParameter, postalCodeParameter, countryParameter, phoneParameter, faxParameter);
        }
    
        public virtual int InsertProduct(string productName, Nullable<int> supplierID, Nullable<int> categoryID, string quantityPerUnit, Nullable<decimal> unitPrice, Nullable<short> unitsInStock, Nullable<short> unitsOnOrder, Nullable<short> reorderLevel, Nullable<bool> discontinued)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertProduct", productNameParameter, supplierIDParameter, categoryIDParameter, quantityPerUnitParameter, unitPriceParameter, unitsInStockParameter, unitsOnOrderParameter, reorderLevelParameter, discontinuedParameter);
        }
        ...
        public virtual int UpdateProductPrice(Nullable<int> productid, Nullable<decimal> productprice)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateProductPrice", productidParameter, productpriceParameter);
        }
    }
}

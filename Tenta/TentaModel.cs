namespace Tenta
{
    ...
    public partial class TentaModel : DbContext
    {
        public TentaModel()
            : base("name=TentaModel")
        {
        }
        ...
        public virtual DbSet<TblOldCustomer> TblOldCustomers { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblOldCustomer>()
                .Property(e => e.Id)
                .IsFixedLength();
